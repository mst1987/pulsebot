                ...
                <details className="rt-more">
                    ...
                    <div className="rt-more-body">
                        ...
                        <div className="rt-switches">
                            ...
                            <SwitchRow label="Warteliste bei vollem Raid" tip="Ist der Raid voll, wird aus einer neuen „Dabei“-Anmeldung die Bank — der Raider erfährt es sofort. Aus: die Anmeldung wird abgelehnt. Wer schon einen Platz hat, behält ihn." checked={plan.overflow !== "off"} onChange={(v) => changePlan({ ...plan, overflow: v ? "bench" : "off" })} />
