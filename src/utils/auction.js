...
async function bidForLegendary(client, interaction, gold) {
    ...
    try {
        const response = await legendary.bid(bidData);
        ...
        console.error("Error in bidForLegendary:", error.message);
        botReply(
            interaction,
            "Fehler",
            "Es ist ein Fehler beim Bieten aufgetreten."
        );
    }
}