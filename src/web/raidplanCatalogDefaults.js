...
// The icons come from src/config/mobIcons.json, generated by scripts/fetch-mob-icons.js (similar WoW icons by kind of
...
let MOB_PORTRAITS = {};
try {
    const generated = require("../config/mobIcons.json");
