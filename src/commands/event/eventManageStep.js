// The buttons and selects of "Event verwalten" (#288) — see services/events/eventManageBot.js
...
const { MANAGE_PREFIX, handleComponent } = require("../../services/events/eventManageBot");
