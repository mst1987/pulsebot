// The dev-only Raid-Helper stand-in (src/utils/raidhelperFixture.js): off in production whatever the variable says, never a network
...
const fixture = require("../../src/utils/raidhelperFixture");
