...
jest.mock("../../src/web/eventPublicPage", () => ({ renderEventPage: jest.fn((id) => (id === "eh-1" ? `EVENT:${id}` : null)) }));
jest.mock("../../src/web/docsPage", () => ({ renderDocsPage: jest.fn((user) => `DOCS:${user ? user.id : "-"}`) }));
