...
jest.mock("../../../src/services/events/raidEventGroups", () => ({ fetchEventsCached: jest.fn(async () => ({ events: [], stale: false })) }));
...
const { fetchEventsCached } = require("../../../src/services/events/raidEventGroups");
...
const { buildChecklist, loadChecklist, setRaidhelperDisabled } = require("../../../src/web/events/raidhelperRetirement");
...
describe("web/events/raidhelperRetirement", () => {
    beforeEach(() => {
        jest.clearAllMocks();
