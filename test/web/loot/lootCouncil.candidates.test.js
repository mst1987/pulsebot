...
describe("web/loot/lootCouncil — the loot history on a candidate", () => {
...
describe("web/loot/lootCouncil — wer das Item überhaupt tragen kann", () => {
    const { candidateSplit } = require("../../../src/web/loot/lootCouncil");
