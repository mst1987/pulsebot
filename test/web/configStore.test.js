...
jest.mock("../../src/web/configSchema", () => {
    const actual = jest.requireActual("../../src/web/configSchema");
    return { ...actual, normalizeConfig: jest.fn(actual.normalizeConfig) };
});

const fs = require("fs");
const { settingsPath } = require("../../src/config/paths");
const { normalizeConfig } = require("../../src/web/configSchema");
...
describe("web/configStore getConfig cache (#420)", () => {
...
describe("web/configStore stored file", () => {
...
describe("web/configStore saveConfig", () => {
...
describe("web/configStore resolveEventSheetLink", () => {
