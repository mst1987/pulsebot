jest.mock("../../../src/services/discord/discord", () => ({ listGuilds: jest.fn() }));
jest.mock("../../../src/web/http/auth", () => ({ getActiveGuild: jest.fn() }));
...
describe("web/http/activeGuild activeGuildFor", () => {
