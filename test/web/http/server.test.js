...
jest.mock("../../../src/web/http/apiRouter", () => ({ handle: jest.fn(() => true) }));
// #424: the server is HTTP only; the jobs start in jobs.js.
jest.mock("../../../src/web/http/jobs", () => ({ startJobs: jest.fn(), stopJobs: jest.fn() }));
jest.mock("../../../src/web/http/staticClient", () => ({ serve: jest.fn(() => true) }));
...
jest.mock("../../../src/web/pages/eventPublicPage", () => ({ renderEventPage: jest.fn(() => null) }));
...
const staticClient = require("../../../src/web/http/staticClient");
const jobs = require("../../../src/web/http/jobs");
...
describe("web/http/server", () => {
    describe("startWebServer", () => {
        ...
        it("starts no background job itself (#424, see jobs.js)", () => {
            ...
            expect(require("fs").readFileSync(require.resolve("../../../src/web/http/server.js"), "utf8")).not.toMatch(/\bstart(RaidEventScan|LogAutoLink|EventMessageSync|Reminders|RoleSync|TalkOverview|EventSeries|SheetCleanup|Jobs)\b/);
        });
