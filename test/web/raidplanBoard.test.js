...
describe("the rest of a board", () => {
    it("has every field even for nothing and reports no content", () => {
        ...
        expect(r.board).toEqual({ tokens: [], slots: [], marks: [], zones: [], icons: [], lines: [], texts: [], targets: [], assignments: [], mobs: [], hiddenCards: [], inheritOff: [], counts: null, roles: {}, notes: "", profileId: "", mapOpacity: 1, objectScale: 1 });
