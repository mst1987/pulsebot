...
const { rosterStats, classDistribution, attendanceShare, MAX_CLASS_SEGMENTS } = require("../../../src/web/characters/rosterStats");
...
describe("web/characters/rosterStats rosterStats", () => {
...
describe("web/characters/rosterStats classDistribution", () => {
