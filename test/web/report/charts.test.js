...
describe("web/report/charts — helpers", () => {
...
describe("web/report/charts — ribbonChart", () => {
    const chart = {
        duration: 120000,
        title: "Debuffs",
        rows: [
...
describe("web/report/charts — markerChart", () => {
    const chart = {
        duration: 60000,
        rows: [
            {
...
describe("web/report/charts — lineChart with a fixed scale and markers", () => {
...
describe("web/report/charts — lineChart", () => {
    const chart = {
        duration: 20000,
        step: 5000,
        series: [
