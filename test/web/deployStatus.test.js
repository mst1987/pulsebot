...
jest.mock("../../src/web/version", () => ({ versionInfo: jest.fn() }));

const axios = require("axios");
const { versionInfo } = require("../../src/web/version");
const { deployStatus, compare, resetDeployCache, REPO, CACHE_MS } = require("../../src/web/deployStatus");
