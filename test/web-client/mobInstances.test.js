...
// tank lines, the labels of the dialogs and the sheet all read it the same way.
const fs = require("fs");
const path = require("path");
const { loadTs, makeT } = require("./i18nHelper");

const auto = loadTs("lib/autoPlace.ts");
const assign = loadTs("lib/assign.ts", { t: makeT("de") });
const modalLib = loadTs("lib/assignModal.ts", { t: makeT("de") });
