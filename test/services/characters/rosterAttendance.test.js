...
} = require("../../../src/services/characters/rosterAttendance");
...
describe("services/characters/rosterAttendance", () => {
    beforeEach(() => {
        jest.clearAllMocks();
...
describe("services/characters/rosterAttendance — attendanceForAccounts (per Discord account)", () => {
