const { gearProfile, fitsRole, HEAL_RATIO, MIN_DPS_HIT } = require("../../../src/services/loot/gearProfile");
...
describe("services/loot/gearProfile", () => {
    ...
    describe("PvP-Gear erkennen", () => {
        const { pvpProfile, isPvpSet, isPvpItem, PVP_SHARE } = require("../../../src/services/loot/gearProfile");
