// The shared board (src/services/raidplan/raidplanBoard.js): slots, marks, zones, cleaning, the
...
describe("group styles", () => {
    const { _internal: { cleanGroupStyles } } = require("../../../src/services/raidplan/raidplanBoard");
...
describe("ring switch and group scales", () => {
    ...
    it("clamps the three group scales to 25 % .. 400 %, 100 % when missing, and leaves other slots at 1", () => {
        ...
        expect(require("../../../src/services/raidplan/raidplanBoard")._internal.cleanFactor(1.234)).toBe(1.23);
    });
});

describe("saved default view", () => {
    const { _internal: { cleanView } } = require("../../../src/services/raidplan/raidplanBoard");
