...
describe("config/paths", () => {
    ...
    it("moves every store with EVENTHELPER_DATA_DIR", () => {
        ...
        expect(require("../../src/stores/eventStore")._internal.EVENTS_FILE).toBe(path.join(dir, "settings", "events.json"));
        expect(require("../../src/stores/reportStore").REPORTS_DIR).toBe(path.join(dir, "reports"));
    });
});
