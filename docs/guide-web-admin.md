...
- **Encounter-Icons**: in der Palette findest du die Boss-Icons der Instanz, Gegner und Boss-Position; ein WoW-Icon lässt sich über seinen Namen einfügen (eine echte Suche folgt später).
