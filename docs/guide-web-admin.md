...
- **Platzhalter für Melees und Ranged:** In der Palette ("Rollen-Gruppen"), in der Werkzeugleiste und im Rechtsklick-Menü des Boards gibt es "Melees" und "Ranged" (auch Heiler, Tanks, DPS): eine Fläche in der Rollenfarbe mit Rollen-Icon, frei verschieb- und skalierbar, mit optionaler Beschriftung, Anzahl-Badge und Form (Fläche, Rechteck, Symbole). Sie braucht keine Spieler und ist deshalb im Sheet immer zu sehen. In Einteilungen und Taktik-Schritten gibt es dazu die Kategorie "Rollen" ("Melees → Boss", "Ranged soaken hier").
