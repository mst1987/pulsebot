...
| eine Suite, die für eine Datei zu groß ist, oder ein Thema quer zu einem Modul | `<modul>.<thema>.test.js` daneben: `test/web/lootCouncil.gear.test.js`; im Client `src/web-client/src/lib/raidplan.slots.test.ts` |
